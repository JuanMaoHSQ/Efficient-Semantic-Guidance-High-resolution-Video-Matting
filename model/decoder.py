...
class RecurrentDecoder(nn.Module):
    ...
    def forward(self,
                s0: Tensor, z: Tensor, f1: Tensor, f2: Tensor, f3: Tensor, f4: Tensor,
                r1: Optional[Tensor], r2: Optional[Tensor],
                r3: Optional[Tensor], r4: Optional[Tensor]):
        s1, s2, s3 = self.avgpool(s0)
        x4, r4 = self.decode4(f4, z, r4)
...
class BottleneckBlock(nn.Module):
    def __init__(self, channels):
        ...
        self.pfd = PFD(channels, channels)
        self.gru = ConvGRU(channels // 2)

    def forward(self, x, z, r: Optional[Tensor]):
        x = self.pfd(x, z)
